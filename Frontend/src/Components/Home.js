  ...
  return (
    <div className="min-h-screen  flex flex-col justify-between bg-gray-100">
      ...
      <main className="flex-grow ">
        <section className="bg-indigo-600 m-[1rem] rounded text-white py-20 text-center">
        ...
        <div className="border m-[1rem]">
            <img  className="w-[100%] rounded-lg h-[30rem]" src={LandingPage} alt="landing page"></img>
        </div>
